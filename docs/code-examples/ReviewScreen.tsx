  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.value}>{reservation.store?.name}</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.label}>상품</Text>
        <Text style={styles.value}>{reservation.product?.name}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  star: { fontSize: 40, marginRight: 5 },
  textArea: {
  ...
  button: { backgroundColor: '#007AFF', padding: 18, borderRadius: 10, alignItems: 'center', marginVertical: 20 },
