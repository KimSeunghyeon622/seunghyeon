...
export default function StoreSignupScreen({ onBack, onSignupComplete, isSocialLogin = false }: StoreSignupScreenProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isSocialLogin ? '업체 정보 입력' : '업주 회원가입'}
        </Text>
        <View style={{ width: 40 }} />
      </View>
